...
#define J1 (-0.75)                  // Intralayer interaction coupling constant
#define J2 (1-0.75)           // Interlayer interaction coupling constant
#define L 16                  // Linear lattice size
#define LAYERS 16             // Number of interacting layers
...
const unsigned int numThermalSweeps = 1048576;  // Sweeps for thermalization
const unsigned int numSweeps = 1048576;         // Number of sweeps
const size_t numTemp = 40;              // 20
const tType minTemperature = 0.15;
const tType maxTemperature = 0.25;
const tType deltaTemperature = (maxTemperature - minTemperature) / (double)numTemp;
