...
#define J1 (-0.5)                  // Intralayer interaction coupling constant
#define J2 (1-0.5)           // Interlayer interaction coupling constant
...
const unsigned int numThermalSweeps = 524288;  // Sweeps for thermalization
const unsigned int numSweeps = 1048576;         // Number of sweeps
const size_t numTemp = 100;              // 20
const tType minTemperature = 0.16;
const tType maxTemperature = 0.26;
